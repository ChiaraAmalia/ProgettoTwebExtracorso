...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="address"> 
                <div><br><h3>MODIFICA TECNICO</h3><br></div>

                <div class="address">
                            {{ Form::model($tecnico, ['method'=>'PUT',
                            'route'=>['tecnicoModifica.update',$tecnico->id], 'id' => 'modifica_tecnico', 'class' => 'contact-form']) }}
                    
                        <!--Codice centro Utente-->
                        <div class="address">
                            <div class="form-group row">
                                {{ Form::label('codice_centro', 'Codice del centro', ['class' => 'label-input']) }}
                                <div class="col-md-6">
                                {{ Form::select('codice_centro', $filtro_codice, old('codice_centro'),['class' => 'input', 'id' => 'codice_centro']) }}
