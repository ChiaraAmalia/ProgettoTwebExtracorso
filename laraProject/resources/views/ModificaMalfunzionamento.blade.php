...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="address">
                <div><br><h3>Modifica Malfunzionamento</h3><br></div>

                <div class="address">
                            {{ Form::model($malfunzionamento, ['method'=>'PUT',
                            'route'=>['malf.update',$malfunzionamento->codice_malfunzionamento], 'id' => 'modificaMalfunzionamento','class' => 'contact-form']) }}        
                    <!--Titolo-->
                    <div class="address">
                        <div class="form-group row">
                            {{ Form::label('titolo', 'Titolo del malfunzionamento', ['class' => 'label-input']) }}
                            <div class="col-md-6">
                                {{ Form::textarea('titolo', old('titolo'), ['class' => 'input', 'id' => 'titolo']) }}
